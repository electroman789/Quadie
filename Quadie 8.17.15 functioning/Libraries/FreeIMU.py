...
class FreeIMU:
    ...
    acc_off_y = -84.6751
    acc_off_z = -2606.6102
    acc_scale_x = 15698.6246
    acc_scale_y = 16449.4324
    acc_scale_z = 17248.0348
    magn_off_x = -148.8467
    magn_off_y = 81.0859
    magn_off_z = -66.5851
    magn_scale_x = 511.9324
    magn_scale_y = 441.3655
    magn_scale_z = 369.8231
    ...
    def getRawValues(self):
        ...
        raw_values[9] = 0.0 #self.baro.getTemperature()
        raw_values[10] = 0.0 #self.baro.getPressure()
