...
PID_PITCH_RATE.definePID(0.9,0.002,0.001)
PID_ROLL_RATE.definePID(1.2,0.002,0.001)
PID_YAW_RATE.definePID(1.0,0.000,0.00)

pitchRateScaler = 20.0 / (0.9 * 100.0)
rollRateScaler = 20.0 / (1.2 * 100.0)
...
if __name__ == '__main__':
    ...
    try:
		...
		timer -= 0
            ...
            #pitch_output = PID_PITCH_RATE.update_pid(rcpit*pitchRateScaler,gyropitch*gyroPitchScaler,1.0)
            #roll_output = PID_ROLL_RATE.update_pid(rcroll*rollRateScaler,gyroroll*gyroRollScaler,1.0)
	    yaw_output = PID_YAW_RATE.update_pid(rcyaw*yawRateScaler,gyroyaw*gyroYawScaler,1.0)
            ...
            #print "gyroyaw = %0.2f  yaw output = %0.2f" %(gyroyaw, yaw_output)
